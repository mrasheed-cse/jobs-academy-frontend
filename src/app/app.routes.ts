...
export const routes: Routes = [
  ...
  { path: 'admin/words/import', loadComponent: () => import('./features/admin/word-import/word-import').then(m => m.WordImport) },
  { path: 'admin/model-tests/create', canActivate: [dictionaryAdminGuard], loadComponent: () => import('./features/admin/model-test-create/model-test-create').then(m => m.ModelTestCreate) },
  { path: 'admin/model-tests/edit/:examId', canActivate: [dictionaryAdminGuard], loadComponent: () => import('./features/admin/model-test-create/model-test-create').then(m => m.ModelTestCreate) },
  { path: '**', redirectTo: '' },
];
